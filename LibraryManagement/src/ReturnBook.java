...
public class ReturnBook extends javax.swing.JFrame {
    ...
    private void t1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t1KeyReleased
        ...
        {
            connect();
            query="select * from issuedbook where StudentId='"+t1.getText()+"';";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            if(rs.next())
            {
                query="insert into returndetails values('"+t1.getText()+"','";
                query+=t2.getText()+"','"+t3.getText()+"','"+t4.getText()+"','"+t5.getText()+"','"+t6.getText()+"');";
                stmt.executeUpdate(query);
                query="delete from issuedbook where StudentId='"+t1.getText()+"';";
                stmt.executeUpdate(query);
                query="update addnewbook set Available='YES' where BookId='"+t3.getText()+"';";
                stmt.executeUpdate(query);
                disconnect();
