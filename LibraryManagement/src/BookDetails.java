...
public class BookDetails extends javax.swing.JFrame {
    ...
    private void c2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c2ActionPerformed
        ...
        connect();
        query="select * from addnewbook where stream='"+c1.getSelectedItem()+"' and class='"+c2.getSelectedItem()+"';";
    ...
    private void txt1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt1KeyReleased
        ...
        else
        {
            ...
            {
                connect();
                query="select * from addnewbook where BookName LIKE \"%"+txt1.getText()+"%\";";
                rs=stmt.executeQuery(query); 
                while(rs.next())
                {
                    BId=rs.getString("BookID");
