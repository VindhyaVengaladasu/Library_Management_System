...
public class IssueBook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
                try
                    {
                        connect();
                        query="select * from addnewbook where BookId='"+t3.getText()+"';";
                        
                        rs=stmt.executeQuery(query); 
                        rs.next();
                        if(t6.getText().equals("YES"))
                        {
                            query="insert into issuedbook values('"+t1.getText()+"','"+t2.getText()+"','"+t3.getText()+"','"+t4.getText()+"','"+Address+"','"+t5.getText()+"','"+SStream+"','"+SClass+"');";
                            
                            stmt.executeUpdate(query);
                            JOptionPane.showMessageDialog(this,"Book with id = "+t3.getText()+" has been issued to "+t2.getText());
                            query="update addnewbook set Available='NO' where BookId='"+t3.getText()+"';";
                            stmt.executeUpdate(query);
    ...
    private void t1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t1KeyReleased
        ...
        {
            connect();
            query="select * from studentregistration where StudentId='"+t1.getText()+"';";
            rs=stmt.executeQuery(query); 
            if(rs.next())
            {
